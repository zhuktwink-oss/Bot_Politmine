...
default_db = {
    "cities": {
        ...
        "city3": {  # <--- ВОТ НОВЫЙ ГОРОД
            "name": "Солнечная Долина",
            "coords": "X: 250, Y: 72, Z: 500",
            "allies": "Стальгорнский Рейх",
            "enemies": "Мрачный",
            "tasks": "1. Собрать урожай пшеницы.\n2. Отремонтировать мельницу.",
            "jobs": {
                "farmer": {
                    "name": "Фермер", 
                    "salary": "800$", 
                    "slots": 10, 
                    "taken": 0, 
                    "desc": "Сажать и собирать урожай на полях."
                },
                "baker": {
                    "name": "Пекарь", 
                    "salary": "1200$", 
                    "slots": 2, 
                    "taken": 0, 
                    "desc": "Печь хлеб из городской муки."
                },
                "guard": {
                    "name": "Стражник", 
                    "salary": "1500$", 
                    "slots": 5, 
                    "taken": 0, 
                    "desc": "Охранять ворота от монстров ночью."
                }
            },
            "shops": [
                {"name": "Рынок", "coords": "X: 260, Y: 72, Z: 510"},
                {"name": "Таверна", "coords": "X: 270, Y: 72, Z: 520"}
            ]
        }
    },
    "users_jobs": {},  
