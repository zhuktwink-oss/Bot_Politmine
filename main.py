...
AD_INTERVAL = 129600  # 86400 24 часа
...
# Словарь для хранения активных задач уведомления: {user_id: asyncio.Task}
...
default_db = {
	...
	"city7": {
		...
		"les": {"name": "Шахтер", "salary": "Зависит от выполненной работы", "slots": 2, "taken": 0, "desc": "С вами свяжется мэр по поводу вашей работы."},
		"les": {"name": "Строитель", "salary": "Зависит от выполненной работы", "slots": 2, "taken": 0, "desc": "С вами свяжется мэр по поводу вашей работы."},
...
async def notify_owner_delayed(user_id, user_mention, city_name, job_name, owner_id):
    try:
        ...
        # Для теста можешь поменять на 10 секунд
