...
AD_INTERVAL = 9999999  # 86400 24 часа
AD_TEXT = "Здесь должна быть реклама, но её нет."
...
default_db = {
    "cities": {
        "city1": {
            ...
            "owner_id": ADMIN_ID,  # <--- ID ВЛАДЕЛЬЦА (СЮДА БУДУТ ПРИХОДИТЬ УВЕДОМЛЕНИЯ)
            "coords": "X: 15288, Z: -11719",
            "allies": "ЕС, Петрозаводск, Balashow",
            "enemies": "СССР",
        ...
        "city2": {
            "name": "Мрачный",
            "owner_id": ADMIN_ID, # Пока стоит твой ID для теста
